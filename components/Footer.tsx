...
const Footer = () => {
    return (
        <div className="px-6 shadow-md bg-[#D9D9D9]">
            <div className="container px-6 flex flex-col md:flex-row items-center justify-between px-6">
                ...
                <nav className="flex  mt-4 md:mt-0 text-gray-600 text-sm justify-center w-1/2">
                    <Link href="/about" className="mx-2 hover:text-gray-100">About Us</Link>
                    <Link href="/faqs" className="mx-2 hover:text-gray-100">FAQs</Link>
                    <Link href="/contact" className="mx-2 hover:text-gray-100">Contact</Link>
                    <Link href="/privacy" className="mx-2 hover:text-gray-100">Privacy Policy</Link>
                </nav>

                {/* Right Section - Social Media */}
                <div className="flex gap-4 mt-4 md:mt-0">
                    <Link href="#" className="text-gray-900 hover:text-gray-100">
